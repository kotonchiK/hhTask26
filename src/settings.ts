...
export const AppSettings = {
    PORT:Number(process.env.PORT), // Порт для запуска App
    ...
    User_Agent_Name:process.env.USER_AGENT_NAME, // Для API заголовка в yr.no
    User_Agent_Mail:process.env.USER_AGENT_MAIL, // Для API заголовка в yr.no
